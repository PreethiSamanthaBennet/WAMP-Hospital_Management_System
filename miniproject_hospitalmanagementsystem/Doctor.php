...
" . mysqli_error($conn); */
     ...
     while($rows = $aResult->fetch_assoc()){
         ...
         echo "Prescription : " . $Patient_Prescription . "<br> <br><br>";
    }
}

?>

<form method="post" action="Doc_UpdatePatientDetails.html">
        <input type="submit" name="UpdatePatientDetails" value="UpdatePatientDetails">
</form>

<?php

if($_POST['UpdatePatientDetails'] == "UpdatePatientDetails") {
      header('Location: Doc_UpdatePatientDetails.html');
}
?>